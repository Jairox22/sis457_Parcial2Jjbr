...
INSERT INTO Programa (idCanal, titulo, descripcion, duracion, productor, fechaEstreno, estado, tipo) VALUES 
(1, 'Noticiero Matutino', 'Noticias de la mañana', 60, 'Juan Perez', '2023-01-15', 1),
(1, 'Show de Comedia', 'Programa de comedia y entretenimiento', 30, 'Ana Gomez', '2023-02-20', 1,'Noticiero'),
(2, 'Documental de Naturaleza', 'Explorando la vida salvaje', 45, 'Carlos Ruiz', '2023-03-10', 0,'Serie'),
(3, 'Programa Deportivo', 'Resumen de eventos deportivos', 60, 'Luis Martinez', '2023-04-05', 1,'Pelicula');
